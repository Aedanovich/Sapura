    ...
    func forgetPassword(email: String) {
        ...
        WebService.sharedInstance.ForgetPassword(email, completion: { error, result in
            ...
            if let errorMessage = error {
                ...
                weakSelf!.showAlertView("Request Sent", message: "You have sent a request to reset the password. Please follow the instructions that will be sent to your email.")
            }
        })
    }
}
